...
async def _bootstrap_db(db_path: Path) -> None:
    ...
    # __schema_migrations tracker so the subsequent FastAPI lifespan
    # _run_migrations pass skips already-applied non-idempotent
    # migrations (e.g. 0023 DROP COLUMN). Matches the
    # _v2m02_w25_helpers.py:bootstrap_db pattern.
