# Relay Individual Contributor License Agreement ("Agreement") v1.0

> **About this document.** This Contributor License Agreement is adapted from
> the Apache Software Foundation's Individual Contributor License Agreement
> v2.2 ([apache.org/licenses/icla.pdf](https://www.apache.org/licenses/icla.pdf)).
> The only changes are: receiving entity ("Epochly, Inc." instead of "The
> Apache Software Foundation"), the project field (Relay), and the contact /
> notification fields. The patent grant scope and all legal terms are identical
> to ASF ICLA v2.2.
>
> This CLA is **signed electronically** via the
> [CLA Assistant Lite](https://github.com/contributor-assistant/github-action)
> GitHub Action on your first pull request — you do **not** email a PDF.
> Signatures are stored at `signatures/version1/cla.json` in this repository.
>
> Every commit must **also** include a `Signed-off-by:` trailer per the
> [Developer Certificate of Origin](https://developercertificate.org/). The
> CLA grants Epochly the copyright + relicense rights; the DCO is the
> per-commit attestation that you have the right to contribute the code.
> See [CONTRIBUTING.md](CONTRIBUTING.md) for the practical workflow.

---

Thank you for your interest in **Relay**, a product of **Epochly, Inc.**
...
distributed by the Company, You reserve all right, title, and interest in
...
that are managed by, or on behalf of, the Company for the purpose of
...
to the Company and to recipients of software distributed by the Company a
...
## 4. Representations: Right to Grant
...
## 5. Representations: Original Creation
...
may submit it to the Company separately from any Contribution, identifying
...
By replying to the CLA Assistant Lite bot comment on a pull request with
the exact phrase below, You sign this Agreement and bind Your contributions
to its terms:

> `I have read the CLA Document and I hereby sign the CLA`

The signature record (your GitHub username, the pull-request number, and
the timestamp) is stored at `signatures/version1/cla.json` in this
repository and is publicly auditable.

## Version

This is Relay CLA version `v1.0`, anchored to ASF ICLA v2.2. Future
versions will bump this field; contributors who signed an earlier version
remain bound to the version they signed unless they explicitly re-sign.
