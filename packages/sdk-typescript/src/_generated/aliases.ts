 ...
 * The TS side uses camelCase property names; this map drives the
 * alias-applying helper functions used by the SDK serializer/deserializer.
 */

export const FIELD_ALIASES_BY_ENVELOPE: Readonly<
