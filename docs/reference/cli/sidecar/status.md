...
| `--json` | `boolean` | no | Emit a single JSON object on stdout with schema_version=relay.cli.sidecar_status.v1 (VAL-V3M2-010). Without --json, output is the default JSON-on-pipe / human-on-TTY contract. |
